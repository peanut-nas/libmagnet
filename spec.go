...
// TorrentSpec Specifies a new torrent for adding to a client, or additions to an existing Torrent. There are
...
// TorrentSpecFromMetaInfoErr The error will be from unmarshalling the info bytes. The TorrentSpec is still filled out as much
...
// TorrentSpecFromMetaInfo Panics if there was anything missing from the metainfo.
